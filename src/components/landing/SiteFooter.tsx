...
export default function SiteFooter() {
  return (
    <footer className="border-t border-line bg-surface px-5 py-14 md:px-10">
      <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-3 font-script text-lg text-brand">
            Sign. Share. Remember.
          </p>
          <p className="mt-3 max-w-xs text-sm text-muted">
            Preserving graduation memories for students across Africa.
          </p>
        </div>
