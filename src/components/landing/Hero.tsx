...
export default function Hero() {
  return (
    <section className="relative overflow-hidden px-5 pb-20 pt-10 md:px-10 md:pb-28 md:pt-14">
      <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="relative z-10 max-w-xl">
          <h1 className="font-display text-[2.75rem] leading-[1.08] tracking-tight text-ink sm:text-5xl md:text-6xl">
            Your Milestone.
            <br />
            Your Story.
            <br />
            <span className="italic text-gradient-brand">Forever Preserved.</span>
          </h1>
          ...
          <dl className="mt-12 grid grid-cols-3 gap-4 border-t border-line pt-8">
            {[
              ...
              <div key={label}>
                <dt className="text-2xl font-bold tracking-tight text-ink md:text-3xl">
                  {stat}
                </dt>
