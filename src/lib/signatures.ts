...
/**
 * Seed placements in shirtie.glb mesh-local space — scattered across
 * front & back so the demo doesn't look lined up in a column.
 */
const SEED_SIGNATURES: ShirtSignature[] = [
  ...
  },
  {
    id: "seed-2",
    name: "Ngozi",
    message: "Next chapter loading…",
    color: "#9f1239",
    side: "front",
    position: [110, 265, 42],
    normal: [0.15, 0.02, 0.99],
    imageData: "",
    scale: 0.95,
    rotation: 11,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    id: "seed-4",
    name: "Zainab",
    message: "Shine on queen",
    color: "#c45c26",
    side: "front",
    position: [55, 385, 35],
    normal: [0.08, 0.12, 0.99],
    imageData: "",
    scale: 0.88,
    rotation: -7,
    createdAt: new Date().toISOString(),
